...
import { Send, MessageSquare, Paperclip, Image, X } from "lucide-react";
...
const mockThreads = [
  {
    id: "t1",
    customer: { name: "Krishansh Verma", avatar: "https://ui-avatars.com/api/?name=Krishansh+Verma&background=4a9a4a&color=fff" },
    lastMessage: "Can you deliver before 6 PM?",
    unread: 2,
  },
  {
    id: "t2",
    customer: { name: "Neha Gupta", avatar: "https://ui-avatars.com/api/?name=Neha+Gupta&background=4a9a4a&color=fff" },
    lastMessage: "Do you have organic certification?",
    unread: 0,
  },
];
...
const initialMessagesByThread = {
  t1: [
    { id: "m1", from: "customer", text: "Hi! I ordered tomatoes.", time: "3:35 PM" },
    { id: "m2", from: "you", text: "Hello! Yes, preparing the order.", time: "3:36 PM" },
    { id: "m3", from: "you", type: "image", url: "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=300&h=300&fit=crop", time: "3:36 PM" },
    { id: "m4", from: "customer", text: "Can you deliver before 6 PM?", time: "3:37 PM" },
  ],
  t2: [
    { id: "m1", from: "customer", text: "Do you have organic certification?", time: "10:10 AM" },
    { id: "m2", from: "you", type: "file", url: "data:text/plain;base64,UEdTIENlcnRpZmljYXRpb24gRG9jdW1lbnQ=", name: "PGS_Certification.pdf", time: "10:12 AM" },
    { id: "m3", from: "you", text: "Yes, PGS certified.", time: "10:12 AM" },
  ],
};
        ...
        <Card className="p-0 overflow-hidden lg:col-span-1">
          ...
          <div className="divide-y divide-forest-200 dark:divide-forest-700">
            {threads.map((t) => (
              ...
              >
                <img src={t.customer.avatar} alt={t.customer.name} className="w-10 h-10 rounded-full" />
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <span className="font-medium text-forest-800 dark:text-forest-100">{t.customer.name}</span>
                    {t.unread > 0 && (
          ...
          {activeThread ? (
            <div className="flex flex-col h-[65vh]">
              <div className="p-4 border-b border-forest-200 dark:border-forest-700 flex items-center space-x-3">
                <img src={activeThread.customer.avatar} alt={activeThread.customer.name} className="w-8 h-8 rounded-full" />
                <div>
                  <div className="font-medium text-forest-800 dark:text-forest-100">{activeThread.customer.name}</div>
